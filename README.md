...
1. **Skills Analysis**:
    ...
    - Python – Intermediate: Comfortable with syntax, loops, functions, classes. I have used Python to build back-end logic in Django.
...
2. **Interests and Values**:
    ...
    🤝 **Collaborative but also Independent-Friendly**
...
2. **Long-term Goals** (3-5 years and beyond):
    ...
    **Goal 4:** Launch the Game Dev Platform Website 
    ...
    - **Achievable**: Leverage the skills I learn in my full-stack JS job to build out the website’s back-end, front-end, and user experience. Having a completed prototype with limited features and a roadmap of taking the project from prototype to launch.
